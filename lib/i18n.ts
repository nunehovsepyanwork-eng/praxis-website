...
const dictionaries = {
  en: {
    ...
    founder: {
      label: "Founder",
      name: "Nune Hovsepyan",
      role: "Founder of PRAXIS | Strategic Communications & Reputation Advisor",
  ...
  hy: {
    ...
    founder: {
      ...
      role: "PRAXIS-ի հիմնադիր | Ռազմավարական հաղորդակցության և հեղինակության զարգացման խորհրդատու",
